...
def parse_inf_value(line, vtype):
    """Parse a value from a standard PRESTO .inf line."""
...
def inf2dict(text):
    """Parse PRESTO .inf file contents into a dictionary."""
    lines = text.strip("\n").splitlines()
...
class PrestoInf(dict):
    ...
    def load_data(self):
        """Return the associated time series data as a numpy float32 array."""
